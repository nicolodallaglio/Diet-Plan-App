        ...
        public boolean open() {
            try {
                ...
                statement.execute("DROP TABLE IF EXISTS " + TABLE_ALIMENTI);
                    ...
                    statement.execute("INSERT INTO " + TABLE_ALIMENTI + " (" + COLUMN_ID + "," + COLUMN_NAME + "," + COLUMN_TIPO + "," + COLUMN_CALORIE + "," + COLUMN_CHO + "," + COLUMN_PROTE + "," + COLUMN_FATS + ")" + "VALUES ('16','proteine in polvere','proteina','120','0','26','1')");
                    ...
                    statement.execute("INSERT INTO " + TABLE_ALIMENTI + " (" + COLUMN_ID + "," + COLUMN_NAME + "," + COLUMN_TIPO + "," + COLUMN_CALORIE + "," + COLUMN_CHO + "," + COLUMN_PROTE + "," + COLUMN_FATS + ")" + "VALUES ('NULL','cereali','grassi','710','0','0','80')");
                    statement.execute("INSERT INTO " + TABLE_ALIMENTI + " (" + COLUMN_ID + "," + COLUMN_NAME + "," + COLUMN_TIPO + "," + COLUMN_CALORIE + "," + COLUMN_CHO + "," + COLUMN_PROTE + "," + COLUMN_FATS + ")" + "VALUES ('NULL','fiocchi di avena','grassi','389','66','16','6.8')");
                    ...
                    statement.execute("INSERT INTO " + TABLE_ALIMENTI + " (" + COLUMN_ID + "," + COLUMN_NAME + "," + COLUMN_TIPO + "," + COLUMN_CALORIE + "," + COLUMN_CHO + "," + COLUMN_PROTE + "," + COLUMN_FATS + ")" + "VALUES ('NULL','cereali cheerios, " + "barchette al cioccolato o equivalenti','carboidrato','367','75','11','6')");
                    statement.execute("INSERT INTO " + TABLE_ALIMENTI + " (" + COLUMN_ID + "," + COLUMN_NAME + "," + COLUMN_TIPO + "," + COLUMN_CALORIE + "," + COLUMN_CHO + "," + COLUMN_PROTE + "," + COLUMN_FATS + ")" + "VALUES ('NULL','biscotti al cioccolato','carboidrato','710','66','4','25')");
                    //verdura
